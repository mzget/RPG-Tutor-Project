...
public class AIPlayer : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        calculationDamage = this.gameObject.GetComponent<HeroStatus>().originalDamage;
    }	

    #region All AI Pathfinding Method.
